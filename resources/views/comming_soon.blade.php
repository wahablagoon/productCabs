...
<head>
	...
	html{
		height:100%;
		background: #ffffff url('{{ url("assets/images/590571.jpg") }}'); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="{{ url("assets/images/logo-white.png") }}" width="20%">
			<h1 id="cspio-title">trippy</h1>			    							    				
